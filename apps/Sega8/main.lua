...
local pad = padlayout and padlayout.new{
    ...
    presets = { {
        name = "Default",
        zones = {
            { id="up",    out=GG.UP,    label="^",    x=52,  y=118, w=64, h=56 },
            { id="left",  out=GG.LEFT,  label="<",    x=0,   y=174, w=56, h=66 },
            { id="down",  out=GG.DOWN,  label="v",    x=56,  y=174, w=60, h=66 },
            { id="right", out=GG.RIGHT, label=">",    x=116, y=174, w=56, h=66 },
            { id="btn_1", out=GG.BTN1,  label="1",    x=188, y=174, w=60, h=66 },
            { id="btn_2", out=GG.BTN2,  label="2",    x=254, y=152, w=66, h=66 },
            { id="start", out=GG.START, label="STRT", x=120, y=0,   w=58, h=30 },
            { id="pause", out=GG.PAUSE, label="PAU",  x=184, y=0,   w=58, h=30 },
