...
{
   RAM_SIZE = 0x20000,
   /* MESHPUNK: 128KB. SuperFX carts map bank 71 at SRAM + 0x10000 and the
    * GSU is told nRamBanks = 2, so a 64KB buffer would put the chip's
    * second RAM bank past the end of the allocation. */
   SRAM_SIZE = 0x20000,
   VRAM_SIZE = 0x10000,
   FILLRAM_SIZE = 0x8000,
};
