...
namespace Renderer
{
    ...
    // MESHPUNK: a zero-copy loaded mesh borrows its vertex/triangle arrays
    // from one malloc'd file blob the Object adopted; free it with the Object.
    Object::~Object()
    {
        if (meshBlob) ::free(meshBlob);
    }
