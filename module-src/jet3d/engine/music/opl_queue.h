...
// MESHPUNK: queue times are uint32 SAMPLE counts (not uint64 microseconds
// as upstream) — the T-Deck backend keeps a sample-count clock, and u64
// time math here would pull u64<->float libgcc helpers the ELF loader
// cannot resolve (see OPL_Queue_AdjustCallbacks).
