...
#include <stddef.h>  // MESHPUNK: size_t for MIDI_LoadBuffer
...
// MESHPUNK: replaces upstream MIDI_LoadFile(filename) — the module parses
// in-memory only (no temp files); the buffer may be freed after loading.
