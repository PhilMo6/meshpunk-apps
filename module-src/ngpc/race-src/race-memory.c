...
/* MESHPUNK: allocated at module start (main_tdeck.c) instead of static —
   a 4MB .bss array made the module image need one ~5.8MB contiguous PSRAM
   block, which boot-dependent fragmentation could break. */
unsigned char *mainrom = 0;
